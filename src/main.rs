...
mod forensic;
mod formats;
// Generated by `loom egui` from PlausiDen-Loom — every basic role
// (primary / surface / ink / border / danger / success) reads from
// `loom_tokens::color::*`. Re-emit when Loom token values change:
//   /home/user/cargo-target/release/loom egui > src/loom_tokens.rs
mod loom_tokens;
mod pages;
mod theme;
mod widgets;
